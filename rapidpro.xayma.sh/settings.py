...
_default_database_config = {
    ...
    "PASSWORD": os.environ.get('DATABASE_PASSWORD', 'temba'),
...
SEND_MESSAGES = os.environ.get("SEND_MESSAGES", False)
...
# -----------------------------------------------------------------------------------
IP_ADDRESSES = os.environ.get("IP_ADDRESSES", "172.16.10.10")
